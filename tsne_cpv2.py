...
# 加载训练好的模型
model_path = 'logs/0310_updn/model.pth'
...
# 保存特征和问题类型
np.save('tsne/saved_features_updn.npy', features)
np.save('tsne/question_types_updn.npy', question_types)
